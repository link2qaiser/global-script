...
function loadModal(url, param,param2,param3) {
    ...
    url = site_url + "/modal/" + url + "?param=" + param+ "&param2=" + param2 + "&param3=" + param3;
    console.log(url);
    $.ajax({
        type: "GET",
        cache: false,
          ...
          ajax: {
            ...
            processResults: function (data) {
                ...
                for(i = 0; i < data.length; i++){
                    data[i]['text'] = data[i]['first_name'] + " "+data[i]['last_name']+ " - "+data[i]['mobile_no']+" - "+data[i]['username'] ;
